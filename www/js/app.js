...
angular.module('App', ['ionic', 'app.controllers', 'app.services', 'app.directives', 'ngCordova', 'ngCordovaOauth', 'firebase'])
...
.constant('FBURL', '<firebase app here>')
    .constant('GOOGLEKEY', '<...apps.googleusercontent.com>')
